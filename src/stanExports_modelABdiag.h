...
namespace model_modelABdiag_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_modelABdiag");
    reader.add_event(42, 40, "end", "model_modelABdiag");
    return reader;
}
#include <stan_meta_header.hpp>
class model_modelABdiag
  : public stan::model::model_base_crtp<model_modelABdiag> {
private:
        int n;
        matrix_d Y;
        double med_y1;
        double med_y2;
public:
    model_modelABdiag(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_modelABdiag_namespace::model_modelABdiag";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("B", "2", 2);
        context__.validate_dims("parameter initialization", "B", "vector_d", context__.to_vec(2));
        ...
        try {
            writer__.vector_lub_unconstrain(0, 1, B);
        } catch (const std::exception& e) {
        ...
        pos__ = 0U;
        validate_non_negative_index("A", "2", 2);
        context__.validate_dims("parameter initialization", "A", "vector_d", context__.to_vec(2));
        ...
        try {
            writer__.vector_lub_unconstrain(0, (1 - max(B)), A);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                B = in__.vector_lub_constrain(0, 1, 2, lp__);
            else
                B = in__.vector_lub_constrain(0, 1, 2);
            current_statement_begin__ = 9;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> A;
            (void) A;  // dummy to suppress unused var warning
            if (jacobian__)
                A = in__.vector_lub_constrain(0, (1 - max(B)), 2, lp__);
            else
                A = in__.vector_lub_constrain(0, (1 - max(B)), 2);
            current_statement_begin__ = 10;
            ...
            validate_non_negative_index("I", "2", 2);
            validate_non_negative_index("I", "2", 2);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> I(2, 2);
            stan::math::initialize(I, DUMMY_VAR__);
            stan::math::fill(I, DUMMY_VAR__);
            current_statement_begin__ = 16;
            validate_non_negative_index("A_mat", "2", 2);
            validate_non_negative_index("A_mat", "2", 2);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> A_mat(2, 2);
            stan::math::initialize(A_mat, DUMMY_VAR__);
            stan::math::fill(A_mat, DUMMY_VAR__);
            current_statement_begin__ = 17;
            validate_non_negative_index("B_mat", "2", 2);
            validate_non_negative_index("B_mat", "2", 2);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> B_mat(2, 2);
            stan::math::initialize(B_mat, DUMMY_VAR__);
            stan::math::fill(B_mat, DUMMY_VAR__);
            // transformed parameters block statements
            current_statement_begin__ = 19;
            stan::math::assign(I, diag_matrix(rep_vector(1.0, 2)));
            current_statement_begin__ = 20;
            stan::math::assign(A_mat, diag_matrix(A));
            current_statement_begin__ = 21;
            stan::math::assign(B_mat, diag_matrix(B));
            ...
            stan::model::assign(lambda, 
                        ...
                        (((get_base1(omega, 1, 1, "omega", 1) + (get_base1(A_mat, 1, 1, "A_mat", 1) * mean(stan::model::rvalue(Y, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), "Y")))) + (get_base1(B_mat, 1, 1, "B_mat", 1) * med_y1)) + (get_base1(B_mat, 1, 2, "B_mat", 1) * med_y2)), 
            ...
            stan::model::assign(lambda, 
                        ...
                        (((get_base1(omega, 2, 1, "omega", 1) + (get_base1(A_mat, 2, 2, "A_mat", 1) * mean(stan::model::rvalue(Y, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list())), "Y")))) + (get_base1(B_mat, 2, 2, "B_mat", 1) * med_y2)) + (get_base1(B_mat, 2, 1, "B_mat", 1) * med_y1)), 
                        "assigning variable lambda");
            ...
            current_statement_begin__ = 15;
            size_t I_j_1_max__ = 2;
            size_t I_j_2_max__ = 2;
            ...
            current_statement_begin__ = 16;
            size_t A_mat_j_1_max__ = 2;
            size_t A_mat_j_2_max__ = 2;
            for (size_t j_1__ = 0; j_1__ < A_mat_j_1_max__; ++j_1__) {
                for (size_t j_2__ = 0; j_2__ < A_mat_j_2_max__; ++j_2__) {
                    if (stan::math::is_uninitialized(A_mat(j_1__, j_2__))) {
                        std::stringstream msg__;
                        msg__ << "Undefined transformed parameter: A_mat" << "(" << j_1__ << ", " << j_2__ << ")";
                        stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable A_mat: ") + msg__.str()), current_statement_begin__, prog_reader__());
                    }
                }
            }
            check_greater_or_equal(function__, "A_mat", A_mat, 0);
            current_statement_begin__ = 17;
            size_t B_mat_j_1_max__ = 2;
            size_t B_mat_j_2_max__ = 2;
            for (size_t j_1__ = 0; j_1__ < B_mat_j_1_max__; ++j_1__) {
                for (size_t j_2__ = 0; j_2__ < B_mat_j_2_max__; ++j_2__) {
                    if (stan::math::is_uninitialized(B_mat(j_1__, j_2__))) {
                        std::stringstream msg__;
                        msg__ << "Undefined transformed parameter: B_mat" << "(" << j_1__ << ", " << j_2__ << ")";
                        stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable B_mat: ") + msg__.str()), current_statement_begin__, prog_reader__());
                    }
                }
            }
            check_greater_or_equal(function__, "B_mat", B_mat, 0);
            // model body
            {
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("I");
        names__.push_back("A_mat");
        names__.push_back("B_mat");
    }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_modelABdiag_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> B = in__.vector_lub_constrain(0, 1, 2);
        size_t B_j_1_max__ = 2;
        for (size_t j_1__ = 0; j_1__ < B_j_1_max__; ++j_1__) {
            vars__.push_back(B(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, 1> A = in__.vector_lub_constrain(0, (1 - max(B)), 2);
        size_t A_j_1_max__ = 2;
        for (size_t j_1__ = 0; j_1__ < A_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            validate_non_negative_index("I", "2", 2);
            validate_non_negative_index("I", "2", 2);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> I(2, 2);
            stan::math::initialize(I, DUMMY_VAR__);
            stan::math::fill(I, DUMMY_VAR__);
            current_statement_begin__ = 16;
            validate_non_negative_index("A_mat", "2", 2);
            validate_non_negative_index("A_mat", "2", 2);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> A_mat(2, 2);
            stan::math::initialize(A_mat, DUMMY_VAR__);
            stan::math::fill(A_mat, DUMMY_VAR__);
            current_statement_begin__ = 17;
            validate_non_negative_index("B_mat", "2", 2);
            validate_non_negative_index("B_mat", "2", 2);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> B_mat(2, 2);
            stan::math::initialize(B_mat, DUMMY_VAR__);
            stan::math::fill(B_mat, DUMMY_VAR__);
            ...
            if (include_tparams__) {
                ...
                for (size_t j_2__ = 0; j_2__ < A_mat_j_2_max__; ++j_2__) {
                    for (size_t j_1__ = 0; j_1__ < A_mat_j_1_max__; ++j_1__) {
                        vars__.push_back(A_mat(j_1__, j_2__));
                    }
                }
                size_t B_mat_j_2_max__ = 2;
                size_t B_mat_j_1_max__ = 2;
                for (size_t j_2__ = 0; j_2__ < B_mat_j_2_max__; ++j_2__) {
                    for (size_t j_1__ = 0; j_1__ < B_mat_j_1_max__; ++j_1__) {
                        vars__.push_back(B_mat(j_1__, j_2__));
                    }
                }
            }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t j_2__ = 0; j_2__ < A_mat_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < A_mat_j_1_max__; ++j_1__) {
                    param_name_stream__.str(std::string());
                    param_name_stream__ << "A_mat" << '.' << j_1__ + 1 << '.' << j_2__ + 1;
                    param_names__.push_back(param_name_stream__.str());
                }
            }
            size_t B_mat_j_2_max__ = 2;
            ...
            for (size_t j_2__ = 0; j_2__ < B_mat_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < B_mat_j_1_max__; ++j_1__) {
                    param_name_stream__.str(std::string());
                    param_name_stream__ << "B_mat" << '.' << j_1__ + 1 << '.' << j_2__ + 1;
                    param_names__.push_back(param_name_stream__.str());
                }
            }
        }
...
typedef model_modelABdiag_namespace::model_modelABdiag stan_model;
#ifndef USING_R
