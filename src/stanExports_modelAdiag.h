...
namespace model_modelAdiag_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_modelAdiag");
    reader.add_event(39, 37, "end", "model_modelAdiag");
    return reader;
}
#include <stan_meta_header.hpp>
class model_modelAdiag
  : public stan::model::model_base_crtp<model_modelAdiag> {
private:
        int n;
        matrix_d Y;
        double med_y1;
        double med_y2;
public:
    model_modelAdiag(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_modelAdiag_namespace::model_modelAdiag";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.vector_lub_unconstrain(0, (1 - max(stan::math::to_row_vector(stan::math::array_builder<local_scalar_t__ >().add((get_base1(B, 1, 1, "B", 1) + get_base1(B, 2, 1, "B", 1))).add((get_base1(B, 1, 2, "B", 1) + get_base1(B, 2, 2, "B", 1))).array()))), A);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                A = in__.vector_lub_constrain(0, (1 - max(stan::math::to_row_vector(stan::math::array_builder<local_scalar_t__ >().add((get_base1(B, 1, 1, "B", 1) + get_base1(B, 2, 1, "B", 1))).add((get_base1(B, 1, 2, "B", 1) + get_base1(B, 2, 2, "B", 1))).array()))), 2, lp__);
            else
                A = in__.vector_lub_constrain(0, (1 - max(stan::math::to_row_vector(stan::math::array_builder<local_scalar_t__ >().add((get_base1(B, 1, 1, "B", 1) + get_base1(B, 2, 1, "B", 1))).add((get_base1(B, 1, 2, "B", 1) + get_base1(B, 2, 2, "B", 1))).array()))), 2);
            current_statement_begin__ = 10;
            ...
            stan::model::assign(lambda, 
                        ...
                        (((get_base1(omega, 1, 1, "omega", 1) + (get_base1(A_mat, 1, 1, "A_mat", 1) * mean(stan::model::rvalue(Y, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), "Y")))) + (get_base1(B, 1, 1, "B", 1) * med_y1)) + (get_base1(B, 1, 2, "B", 1) * med_y2)), 
            ...
            stan::model::assign(lambda, 
                        ...
                        (((get_base1(omega, 2, 1, "omega", 1) + (get_base1(A_mat, 2, 2, "A_mat", 1) * mean(stan::model::rvalue(Y, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list())), "Y")))) + (get_base1(B, 2, 2, "B", 1) * med_y2)) + (get_base1(B, 2, 1, "B", 1) * med_y1)), 
                        "assigning variable lambda");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_modelAdiag_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> A = in__.vector_lub_constrain(0, (1 - max(stan::math::to_row_vector(stan::math::array_builder<local_scalar_t__ >().add((get_base1(B, 1, 1, "B", 1) + get_base1(B, 2, 1, "B", 1))).add((get_base1(B, 1, 2, "B", 1) + get_base1(B, 2, 2, "B", 1))).array()))), 2);
        size_t A_j_1_max__ = 2;
        for (size_t j_1__ = 0; j_1__ < A_j_1_max__; ++j_1__) {
...
typedef model_modelAdiag_namespace::model_modelAdiag stan_model;
#ifndef USING_R
